...
import type { RuntimeJackedSnapshot } from "../../../src/core/api-contract";
import { createJackedApi } from "../../../src/trpc/jacked-api";
...
function createDeps() {
	...
	return { monitor, client, api: createJackedApi({ monitor: monitor as never, client: client as never }) };
}

describe("createJackedApi reimportCursorAccount", () => {
