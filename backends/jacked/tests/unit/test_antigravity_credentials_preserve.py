...
from jacked.antigravity.credentials import refresh_access_token, write_oauth_creds
...
def test_refresh_access_token_merges_unknown_fields(monkeypatch):
    ...
    monkeypatch.setattr("jacked.antigravity.credentials.httpx.Client", FakeClient)
