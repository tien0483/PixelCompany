...
``manager.service.menubar_summary`` (no rumps/pyobjc here).
"""

from fastapi import APIRouter, Request, status
from fastapi.responses import JSONResponse

from manager.service.menubar_summary import (
...
async def menubar_summary(request: Request):
    ...
    active_id = None
    try:
        from manager.api.routes.auth import get_active_credential
