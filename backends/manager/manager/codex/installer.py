...
from manager.install_manifest import skill_content_hash as _skill_content_hash
...
#   manager-setup.md  - generates a repo-local .claude/commands + .claude/skills
...
_CLAUDE_ONLY_COMMANDS = frozenset(
    {"swarm.md", "goal-maker.md", "browser-reset.md", "manager-setup.md", "jacked-setup.md"}
)
