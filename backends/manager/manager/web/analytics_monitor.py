...
def _rollup_pending_days(db) -> None:
    ...
    """
    from manager.web.analytics_db import AnalyticsDB  # noqa: F401 — type hint
...
async def initial_scan_loop(app) -> None:
    ...
    from manager.web.analytics_scanner import scan_all_projects
    from manager.web.analytics_paths import get_claude_data_dirs
    ...
    try:
        ...
        try:
            from manager.web.analytics_anomalies import detect_anomalies, auto_resolve_flags
...
async def live_monitor_loop(app) -> None:
    ...
    from manager.web.analytics_paths import get_claude_data_dirs, find_active_jsonl_files
    from manager.web.analytics_scanner import parse_jsonl_from_offset
    ...
    while True:
        try:
            ...
            if affected_sessions:
                try:
                    from manager.web.analytics_anomalies import (
                        detect_anomalies,
                        auto_resolve_flags,
                    )
