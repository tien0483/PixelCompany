...
def _mac_menubar_available() -> bool:
    ...
    if sys.platform != "darwin":
        return False
    try:
        from manager.service.menubar_mac import RUMPS_AVAILABLE
...
class ServiceRunner:
    ...
    def _on_toggle_autostart(self):
        from manager.service.platform import (
            detect_autostart,
            install_autostart,
            uninstall_autostart,
        )
    ...
    def _on_update_click(self):
        ...
        from manager.install_method import can_auto_upgrade as _can_upgrade
        ...
        try:
            ...
            from manager.service.updater import UPDATE_LOG as _bc_log
        ...
        try:
            ...
            try:
                from manager.api.main import WEB_DIR
            ...
            try:
                from manager.service import update_status as _us
                from manager.service.updater import UPDATE_LOG as _upd_log
                from manager.install_method import detect_install_method as _det
                from manager import __version__ as _cv
                _us.init_status(
            ...
            try:
                from manager.service.updater import spawn_updater_from_tray
    ...
    def _run_mac_menubar(self) -> None:
        ...
        from manager.service.menubar_mac import MacMenuBarApp
    ...
    def run(self) -> None:
        ...
        from manager.service.restart import set_restart_handler
