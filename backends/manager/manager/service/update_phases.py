...
Consumed by:
  - manager.service.updater.run_update() (POSIX updater)
  - manager.service.updater._spawn_windows_tray_updater() (Windows batch generator)
  - manager.cli._spawn_windows_upgrade_helper() (Windows batch generator)
