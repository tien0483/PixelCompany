...
PILL_INTERVAL = 30
# Fast in-process change watcher: a 1s timer comparing manager.usage_events
...
if RUMPS_AVAILABLE:
    ...
    class MacMenuBarApp(rumps.App):
        ...
        Constructed with the owning :class:`~manager.service.tray.ServiceRunner`;
        ...
        def __init__(self, runner):
            ...
            # manager.usage_events in this same process; watching the counter
            # updates the pill within ~1s of a dashboard refresh instead of
            # waiting out the 30s poll.
            from manager import usage_events
        ...
        def _refresh_pill(self, _timer):
            ...
            from manager.service.menubar_summary import menubar_title
