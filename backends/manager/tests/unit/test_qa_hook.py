...
class TestHasUiChanges:
    ...
    def test_detects_js_files(self):
        from manager.hooks.qa_suggest import _has_ui_changes
...
class TestShouldSuggest:
    ...
    def test_returns_true_with_ui_changes(self, tmp_path):
        ...
        from manager.hooks.qa_suggest import _should_suggest
        ...
        with patch(
            "manager.hooks.qa_suggest._get_changed_files",
...
class TestGetChangedFiles:
    ...
    def test_returns_file_list(self, tmp_path):
        from manager.hooks.qa_suggest import _get_changed_files
...
class TestSuggestionMessageRuntime:
    ...
    def test_default_message_unchanged(self):
        ...
        from manager.hooks.qa_suggest import _suggestion_message
...
class TestParseRuntime:
    ...
    def test_parses_codex(self):
        from manager.hooks.qa_suggest import _parse_runtime
...
class TestMainEndToEnd:
    ...
    def test_emits_suggestion_on_ui_changes(self, tmp_path, capsys):
        from manager.hooks.qa_suggest import main
        ...
        with patch("sys.stdin") as mock_stdin, patch(
            ...
            "manager.hooks.qa_suggest.DEDUP_DIR", str(dedup_dir)
        ):
