"""Unit tests for manager.web.analytics_scanner — incremental JSONL scanner.
...
from manager.web.analytics_scanner import (
...
class TestPruneStaleScanState:
    def test_prune_removes_deleted_files(self, tmp_path):
        from manager.web.analytics_scanner import prune_stale_scan_state
