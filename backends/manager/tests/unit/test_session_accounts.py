...
from manager.api.watchers import _any_claude_process_alive  # noqa: E402
...
def test_any_claude_process_alive_true():
    ...
    with mock.patch("manager.api.watchers.subprocess.run", return_value=mock_result):
...
def test_any_claude_process_alive_exception():
    ...
    """
    with mock.patch(
        "manager.api.watchers.subprocess.run",
