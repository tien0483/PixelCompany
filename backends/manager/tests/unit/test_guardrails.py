"""Tests for manager.guardrails module."""

import os
from pathlib import Path


from manager import guardrails
...
class TestDetectLanguage:
    ...
    def test_python_pyproject(self, tmp_path):
        ...
        >>> from manager.guardrails import detect_language
        >>> detect_language(d)
        'python'
        """
...
class TestDetectHookFramework:
    ...
    def test_no_framework(self, tmp_path):
        ...
        >>> import tempfile
        >>> from manager.guardrails import _detect_hook_framework
        >>> from pathlib import Path
...
class TestTemplateContent:
    ...
    def test_base_template_exists(self):
        ...
        >>> from manager.guardrails import GUARDRAILS_TEMPLATES
    ...
    def test_all_hook_templates_exist(self):
        ...
        >>> from manager.guardrails import HOOK_TEMPLATES
    ...
    def test_hook_templates_have_marker(self):
        ...
        >>> from manager.guardrails import HOOK_TEMPLATES, HOOK_MARKER
