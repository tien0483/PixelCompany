...
import manager.api.routes.settings_remote as sr
from manager.api.main import app
from manager.service.bind import BindPlan, set_active_plan
...
def db(tmp_path):
    ...
    database = Database(str(tmp_path / "manager.db"))
...
def test_restart_broadcasts_and_calls_handler_not_execv(client, monkeypatch):
    ...
    import manager.service.restart as restart_mod
