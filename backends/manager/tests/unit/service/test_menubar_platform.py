...
from manager.service.tray import ServiceRunner, select_menubar_backend
...
def test_menubar_mac_importable_and_loopback():
    from manager.service import menubar_mac
...
def test_cli_menubar_rejects_non_darwin():
    ...
    with mock.patch("manager.cli.sys.platform", "linux"):
