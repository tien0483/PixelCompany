"""Tests for manager.service.process module."""
...
class TestWritePid:
    def test_writes_pid_to_file(self, tmp_path):
        ...
        from manager.service.process import write_pid
...
class TestReadPid:
    def test_reads_valid_pid_file(self, tmp_path):
        ...
        from manager.service.process import read_pid
...
class TestIsProcessAlive:
    def test_current_process_is_alive(self):
        from manager.service.process import is_process_alive
...
class TestCheckPort:
    def test_unused_port_is_available(self):
        from manager.service.process import is_port_available
...
class TestStopProcess:
    def test_returns_false_for_no_pid_file(self, tmp_path):
        pid_file = tmp_path / "nope.pid"
        from manager.service.process import stop_process
    ...
    def test_sends_sigterm_on_unix(self, mock_kill, tmp_path):
        ...
        from manager.service.process import stop_process
        with patch("manager.service.process.is_process_alive", return_value=True):
...
class TestWaitForPortFree:
    def test_returns_true_immediately_if_free(self):
        from manager.service.process import wait_for_port_free
