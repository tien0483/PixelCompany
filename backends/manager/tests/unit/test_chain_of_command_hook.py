...
class TestStripFrontmatter:
    def test_strips_leading_yaml_block(self):
        from manager.hooks.chain_of_command_context import _strip_frontmatter
...
class TestHookMain:
    def test_prints_preamble_and_body_strips_frontmatter(
        ...
        from manager.hooks import chain_of_command_context as hook
...
class TestInstall:
    def test_adds_synchronous_sessionstart_entry(self, tmp_path):
        from manager.cli import _install_chain_of_command_hook

        settings_path = tmp_path / "settings.json"
        existing = {"hooks": {}}
        with patch("manager.findbin.find_bin", return_value="/fake/bin/jacked"):
...
class TestRemove:
    def test_removes_only_our_entry(self, tmp_path):
        from manager.cli import _remove_chain_of_command_hook
...
class TestHookRegistration:
    def test_hook_is_in_valid_hook_names(self):
        from manager.cli import _valid_hook_names
