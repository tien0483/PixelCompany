...
from manager.hooks import memory_capture
from manager.memory import capture, hooks_config
...
def test_capture_failure_writes_to_memory_log(env):
    ...
    _clear()
    vault_mod.ensure_memory_file_logging()  # home from manager_HOME (env fixture)
    try:
        _init_enabled_vault(env)
