import json
from manager import install_summary as s
from manager.install_manifest import ManifestDiff, CategoryDiff
...
from manager.cli import main  # noqa: E402
...
def test_cli_install_writes_manifest_and_summary(tmp_path, monkeypatch):
    ...
    monkeypatch.setattr("manager.cli._setup_tray_autostart", lambda: None)
    runner = CliRunner()
