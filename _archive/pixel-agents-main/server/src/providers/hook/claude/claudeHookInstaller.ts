// RETIRED — Pixel Agents must not install Claude hooks when Kanban is the shell.
// See server/src/INGESTION_RETIRED.ts. Use `kanban hooks doctor` to verify coexistence.
