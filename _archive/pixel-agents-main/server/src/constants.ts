...
/** Despawn an adopted external agent after this long with no JSONL writes, so a
 *  quit/closed session clears from the office instead of lingering. It re-adopts
 *  automatically if the session resumes and writes again. */
export const EXTERNAL_IDLE_DESPAWN_MS = 90_000;
...
// ── Texel Engine ────────────────────────────────────────────
export const TEXEL_AGENT_MAX_STEPS = 80;
export const TEXEL_DEFAULT_PALETTE_SIZE = 16;
