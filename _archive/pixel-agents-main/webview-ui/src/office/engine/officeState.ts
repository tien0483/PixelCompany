...
export class OfficeState {
  ...
  addNpc(placedNpc: PlacedNpc): void {
    ...
    let spawn = this.walkableTiles[Math.floor(Math.random() * this.walkableTiles.length)];
    const ch = createCharacter(placedNpc.id, placedNpc.palette, placedNpc.seatId || null, null, placedNpc.hueShift);
  ...
  update(realDt: number): void {
    ...
    for (const ch of this.characters.values()) {
      ...
      this.withOwnSeatUnblocked(ch, () =>
        updateCharacter(ch, dt, this.walkableTiles, this.seats, this.tileMap, this.blockedTiles, this.isReplayMode),
      );
