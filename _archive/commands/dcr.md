...
If the config overlay date is more than 90 days old, mention: "Your `/dcr` config is over 90 days old — consider running `/manager-setup dcr` to refresh it."
...
> **Tip:** Run `/manager-setup dcr` to pre-configure lens selection, context paths, and domain-specific wild cards for this repo.
