...
> **Note:** If `.claude/commands/release.md` exists in the current repo, that version has pre-filled repo config from `/manager-setup release` — use it instead of this global file. If it doesn't exist, continue here.
