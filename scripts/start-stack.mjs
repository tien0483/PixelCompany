...
/** Freed by --restart: a stale Manager/HTML/OmniRoute sidecar would stop the runtime from starting its own. */
const RESTART_PORTS = [RUNTIME_PORT, WEB_UI_PORT, MANAGER_PORT, HTML_PORT, OMNIROUTE_PORT];
