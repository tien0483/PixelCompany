...
import { getRuntimeAgentCatalogEntry, isRuntimeAgentLaunchSupported } from "@runtime-agent-catalog";
...
export const TASK_START_ONBOARDING_SLIDES: OnboardingSlide[] = [
	{
		...
		description:
			"Press c to create a task yourself, or talk to the sidebar PIXTiel agent to plan work for you. It can pull projects and issues from Linear and GitHub, then turn them into tasks your coding agent can pick up.",
		assetVideoUrl: "https://github.com/user-attachments/assets/4408930c-33cd-4af9-a343-e82b099eab8c",
		assetAlt: "Talking to the sidebar PIXTiel agent to create tasks from Linear and GitHub",
		assetWidthPx: 1908,
		assetHeightPx: 720,
	},
	{
...
export function TaskStartAgentOnboardingCarousel({
	...
	const clineSettings = useRuntimeSettingsClineController({
		open,
		workspaceId,
		// Never fall back to "cline": the controller fetches the Cline provider
		// catalog for that id, which pulls the gated SDK routes.
		selectedAgentId: activeAgentId ?? selectedAgentId ?? "claude",
