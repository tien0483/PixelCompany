...
import type { NpcAction, OfficeLayout, TileType as TileTypeVal } from '../types.js';
...
export class EditorState {
  ...
  brushNpcPalette = 0;
  brushNpcHue = 0;
  brushNpcScript: NpcAction[] = [{ kind: 'wander', seconds: 5 }];
  ...
  reset(): void {
    ...
    this.brushNpcPalette = 0;
    this.brushNpcHue = 0;
    this.brushNpcScript = [{ kind: 'wander', seconds: 5 }];
  }
}
